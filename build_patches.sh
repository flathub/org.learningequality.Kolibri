...
diff -u /dev/null src/gnome_search_provider_service.py > patches/gnome_search_provider_service.py.patch
...
diff -u /dev/null src/dbus_activation_service.py > patches/dbus_activation_service.py.patch
